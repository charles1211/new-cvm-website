...
type Category = "All" | "Achievement" | "Company News" | "Updates" | "Community" | "Partnership";
...
const articles: NewsArticle[] = [
  {
    ...
    date: "November 2023",
    readTime: "5 min read",
    title: "ISO 9001:2015 Standard Recertification Success for CVM Finance and Credit Corporation",
    excerpt:
  ...
  },
  {
    ...
    date: "February 2024",
    readTime: "3 min read",
    title: "CVM Finance Partners with Leading Digital Wallets for Easier Loan Payments",
    excerpt:
  ...
  },
  {
    ...
    date: "December 2023",
    readTime: "3 min read",
    title: "Financial Literacy Drive: Empowering SSS Pensioners Across the Philippines",
    excerpt:
...
const categories: Category[] = ["All", "Achievement", "Company News", "Updates", "Community", "Partnership"];
