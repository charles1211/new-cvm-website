...
const reasons = [
  // {
  //   icon: Shield,
  //   title: "SEC Registered & BSP Supervised",
  //   description: "We are a fully accredited and regulated lending institution you can trust.",
  //   color: "bg-blue-50 text-primary",
  // },
  {
    icon: Zap,
    title: "Fast Loan Processing",
    description: "Quick approval process with minimal requirements. Get your loan in days, not weeks.",
  ...
  },
  {
    ...
    description: "Founded in 1994, we have over three decades of experience serving Filipino borrowers.",
